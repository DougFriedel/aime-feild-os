...
function LoginScreen({onLogin}){
  ...
  return(
    <div style={{minHeight:"100vh",backgroundImage:"url(/Background.jpg)",backgroundSize:"cover",backgroundPosition:"center",backgroundRepeat:"no-repeat",display:"flex",flexDirection:"column",justifyContent:"center",padding:24,fontFamily:"inherit",position:"relative"}}>
      {/* Dark overlay for readability */}
      <div style={{position:"absolute",inset:0,background:"rgba(5,5,10,0.72)",backdropFilter:"blur(1px)"}}/>
